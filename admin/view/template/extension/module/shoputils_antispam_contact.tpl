          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-success<?php echo $m_shoputils_antispam_contact_registr_status ? ' active' : ''; ?>"><input type="radio" name="m_shoputils_antispam_contact_registr_status" value="1"<?php echo $m_shoputils_antispam_contact_registr_status ? ' checked="checked"' : ''; ?> /> <?php echo $text_enabled; ?></label>
                      <label class="btn btn-danger<?php echo !$m_shoputils_antispam_contact_registr_status ? ' active' : ''; ?>"><input type="radio" name="m_shoputils_antispam_contact_registr_status" value="0"<?php echo !$m_shoputils_antispam_contact_registr_status ? ' checked="checked"' : ''; ?> /> <?php echo $text_disabled; ?></label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-success<?php echo $m_shoputils_antispam_contact_affiliate_status ? ' active' : ''; ?>"><input type="radio" name="m_shoputils_antispam_contact_affiliate_status" value="1"<?php echo $m_shoputils_antispam_contact_affiliate_status ? ' checked="checked"' : ''; ?> /> <?php echo $text_enabled; ?></label>
                      <label class="btn btn-danger<?php echo !$m_shoputils_antispam_contact_affiliate_status ? ' active' : ''; ?>"><input type="radio" name="m_shoputils_antispam_contact_affiliate_status" value="0"<?php echo !$m_shoputils_antispam_contact_affiliate_status ? ' checked="checked"' : ''; ?> /> <?php echo $text_disabled; ?></label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="m_shoputils_antispam_contact_word" id="input-word" placeholder="<?php echo $entry_word; ?>" class="form-control"><?php echo $m_shoputils_antispam_contact_word; ?></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="m_shoputils_antispam_contact_ip" id="input-ip" placeholder="<?php echo $entry_ip; ?>" class="form-control"><?php echo $m_shoputils_antispam_contact_ip; ?></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-success<?php echo $m_shoputils_antispam_contact_not_found ? ' active' : ''; ?>"><input type="radio" name="m_shoputils_antispam_contact_not_found" value="1"<?php echo $m_shoputils_antispam_contact_not_found ? ' checked="checked"' : ''; ?> /> <?php echo $text_enabled; ?></label>
                      <label class="btn btn-danger<?php echo !$m_shoputils_antispam_contact_not_found ? ' active' : ''; ?>"><input type="radio" name="m_shoputils_antispam_contact_not_found" value="0"<?php echo !$m_shoputils_antispam_contact_not_found ? ' checked="checked"' : ''; ?> /> <?php echo $text_disabled; ?></label>
                  </div>
            ...
            <div class="tab-pane" id="tab-log">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="hidden" name="m_shoputils_antispam_contact_contact_log_filename" value="<?php echo $log_filename ?>" />
                    <select name="m_shoputils_antispam_contact_contact_log" id="input-log" class="form-control">
                      <?php foreach ($logs as $key => $value) { ?>
                      <?php if ($key == $m_shoputils_antispam_contact_contact_log) { ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="hidden" name="m_shoputils_antispam_contact_registr_log_filename" value="<?php echo $log_registr_filename ?>" />
                    <select name="m_shoputils_antispam_contact_registr_log" id="input-log" class="form-control">
                      <?php foreach ($logs as $key => $value) { ?>
                      <?php if ($key == $m_shoputils_antispam_contact_registr_log) { ?>
                      <option value="<?php echo $key; ?>"
                          selected="selected"><?php echo $value; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $key; ?>"><?php echo $value; ?></option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="hidden" name="m_shoputils_antispam_contact_affiliate_log_filename" value="<?php echo $log_affiliate_filename ?>" />
                    <select name="m_shoputils_antispam_contact_affiliate_log" id="input-log" class="form-control">
                      <?php foreach ($logs as $key => $value) { ?>
                      <?php if ($key == $m_shoputils_antispam_contact_affiliate_log) { ?>
                      <option value="<?php echo $key; ?>"
                          selected="selected"><?php echo $value; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $key; ?>"><?php echo $value; ?></option>
